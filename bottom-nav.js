...
(function() {
    ...
    function initializeNav() {
        ...
        // After the window and all assets (images, iframes, etc.) are fully loaded...
        window.addEventListener('load', () => {
            // Re-calculate the position one last time to ensure it's perfect.
            setActiveLink();
            // NOW, and only now, enable the smooth transition for future movements.
